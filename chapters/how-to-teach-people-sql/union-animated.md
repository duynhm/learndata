...
![The two tables referenced and the unionized version of the tables](union_1.jpeg)
...
![gif showing how the union runs through each table to build the result](union_2.gif)
...
[[cross-join-animated|Next - Cross Join - Animated]]